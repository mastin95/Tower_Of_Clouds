...
type: architecture
status: reference
tags: [arquitectura, referencia-tecnica]
updated: 2026-04-24
---

# Engine Reference Documentation

> **Nota Obsidian:** dentro de unity/ y unreal/ hay notas con nombres base repetidos
> (VERSION, PLUGINS, animation, audio, etc.). Se mantienen así porque esta
> carpeta funciona como librería técnica importada. Para evitar ambigüedad en
> Obsidian, navega esta librería por carpetas o por enlaces relativos, no como
> wiki-links globales.
