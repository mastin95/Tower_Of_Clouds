...
> **Nota de contexto del vault:** este documento pertenece al template original.
> Los ejemplos de rutas como `design/gdd/`, `docs/architecture/` o
> `docs/engine-reference/` deben leerse como **rutas legacy**. En este vault,
> la estructura vigente se organiza desde [[00_Indice]], [[MOC_Producto]] y
> [[MOC_Arquitectura]].
