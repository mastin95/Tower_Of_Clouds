...
> **Nota de contexto del vault:** guía heredada del template. Las rutas
> mencionadas dentro del documento reflejan la estructura original del template,
> no la estructura actual del vault.
