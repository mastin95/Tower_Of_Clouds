...
> **Nota de contexto del vault:** estos ejemplos son históricos y muestran el
> flujo del template original. Las rutas que aparecen dentro de las sesiones
> (`design/gdd/`, `docs/architecture/`, etc.) no son la estructura vigente del
> vault actual.
